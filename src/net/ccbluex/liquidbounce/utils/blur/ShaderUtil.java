...
/*     */   
/*     */   public void init() {
/* 120 */     GL20.glUseProgram(this.programID);
/*     */   }
/*     */   
/*     */   public void unload() {
...
/* 128 */     return GL20.glGetUniformLocation(this.programID, name);
/*     */   }
/*     */   
/*     */   public void setUniformf(String name, float... args) {
/* 132 */     int loc = GL20.glGetUniformLocation(this.programID, name);
/* 133 */     switch (args.length) {
/*     */       case 1:
/* 135 */         GL20.glUniform1f(loc, args[0]);
/*     */         break;
/*     */       case 2:
/* 138 */         GL20.glUniform2f(loc, args[0], args[1]);
/*     */         break;
/*     */       case 3:
/* 141 */         GL20.glUniform3f(loc, args[0], args[1], args[2]);
/*     */         break;
/*     */       case 4:
/* 144 */         GL20.glUniform4f(loc, args[0], args[1], args[2], args[3]);
/*     */         break;
/*     */     } 
/*     */   }
/*     */   
/*     */   public void setUniformi(String name, int... args) {
/* 150 */     int loc = GL20.glGetUniformLocation(this.programID, name);
/* 151 */     if (args.length > 1) { GL20.glUniform2i(loc, args[0], args[1]); }
/* 152 */     else { GL20.glUniform1i(loc, args[0]); }
/*     */   
/*     */   }
/*     */   private int createShader(InputStream inputStream, int shaderType) {
/* 156 */     int shader = GL20.glCreateShader(shaderType);
/* 157 */     GL20.glShaderSource(shader, FileUtils.readInputStream(inputStream));
/* 158 */     GL20.glCompileShader(shader);
/*     */ 
/*     */     
/* 161 */     if (GL20.glGetShaderi(shader, 35713) == 0) {
/* 162 */       System.out.println(GL20.glGetShaderInfoLog(shader, 4096));
/* 163 */       throw new IllegalStateException(String.format("Shader (%s) failed to compile!", new Object[] { Integer.valueOf(shaderType) }));
/*     */     } 
/*     */     
/* 166 */     return shader;
/*     */   }
...
/* Location:              C:\Users\Administrator\Desktop\XSJ Client v2.3 New Year's Special Edition.jar!\net\ccbluex\liquidbounc\\utils\blur\ShaderUtil.class
