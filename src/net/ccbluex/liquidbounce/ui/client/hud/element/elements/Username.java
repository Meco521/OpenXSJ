...
/*     */   
/*  23 */   public Username() { super(0.0D, 0.0D, 0.0F, null, 15, null);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  38 */     Intrinsics.checkExpressionValueIsNotNull(MinecraftInstance.mc2.func_110432_I(), "mc2.getSession()"); String name = MinecraftInstance.mc2.func_110432_I().func_111285_a();
/*  39 */     String lengt = name;
/*  40 */     String str1 = (String)this.OutmodeValue.get(); boolean bool = false; if (str1 == null) throw new TypeCastException("null cannot be cast to non-null type java.lang.String");  Intrinsics.checkExpressionValueIsNotNull(str1.toLowerCase(), "(this as java.lang.String).toLowerCase()"); str1 = str1.toLowerCase(); switch (str1.hashCode()) {
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*     */       case 66125872:
/* 144 */         if (str1.equals("outline2"))
/* 145 */         { RoundedUtil.drawRound(
/* 146 */               -1.0F, 
/* 147 */               0.0F, 
/* 148 */               (float)(lengt.length() * 4.5D + 38), 
/* 149 */               16.0F, 
/* 150 */               6.4F, new Color(0, 0, 0, ((Number)this.bgValue.get()).intValue()));
/*     */           
/* 152 */           if (((Boolean)this.Outline.get()).booleanValue())
/* 153 */             ScaleUtils.drawGidentOutlinedRoundedRect3(-1.0D, 0.0D, lengt.length() * 4.5D + 38, 16.0D, 6.4D, ((Number)CustomColor.line.get()).floatValue());  }  break;case 110119: if (str1.equals("old")) { if (MinecraftInstance.mc.getThePlayer() == null)
...
/* 159 */           Color gradientColor2 = 
/* 160 */             new Color(((Number)CustomColor.r.get()).intValue(), ((Number)CustomColor.g.get()).intValue(), ((Number)CustomColor.b.get()).intValue(), ((Number)CustomColor.a.get()).intValue());
/* 161 */           Color gradientColor3 = 
...
/* 163 */           Color gradientColor4 = 
/* 164 */             new Color(((Number)CustomColor.r2.get()).intValue(), ((Number)CustomColor.g2.get()).intValue(), ((Number)CustomColor.b2.get()).intValue(), ((Number)CustomColor.a2.get()).intValue());
/*     */           
/* 166 */           RoundedUtil.drawGradientRound(
/* 167 */               -1.0F, 
/* 168 */               0.0F, 
/* 169 */               (float)(lengt.length() * 4.5D + 38), 
/* 170 */               16.0F, ((Number)CustomColor.ra.get()).floatValue(), 
/* 171 */               ColorUtil.applyOpacity(gradientColor4, 0.85F), gradientColor1, gradientColor3, gradientColor2); }  break;
/*     */       case 66125871:
/*     */         if (str1.equals("outline1")) { RoundedUtil.drawRound(-1.0F, 0.0F, (float)(lengt.length() * 4.5D + 38), 16.0F, 6.4F, new Color(0, 0, 0, ((Number)this.bgValue.get()).intValue())); if (((Boolean)this.Outline.get()).booleanValue())
/*     */             ScaleUtils.drawOutline(5.0F, 0.0F, lengt.length() * 4.5F + 32, 4.0F, 6.4F, ((Number)CustomColor.line.get()).floatValue(), 3.0F);  }
/*     */          break;
/* 176 */     }  Intrinsics.checkExpressionValueIsNotNull(Color.white, "Color.white"); CFontLoad.WL24.drawString("H", 4.0F, 5.0F, Color.white.getRGB());
/* 177 */     Intrinsics.checkExpressionValueIsNotNull(Color.white, "Color.white"); FontLoaders.S18.drawString(name, 21.0F, 4, Color.white.getRGB());
/* 178 */     GL11.glTranslated(-getRenderX(), -getRenderY(), 0.0D);
/* 179 */     GL11.glScalef(1.0F, 1.0F, 1.0F);
/* 180 */     GL11.glPushMatrix();
/* 181 */     GL11.glPopMatrix();
/* 182 */     GL11.glScalef(getScale(), getScale(), getScale());
/* 183 */     GL11.glTranslated(getRenderX(), getRenderY(), 0.0D);
/*     */ 
/*     */     
/* 186 */     return new Border(0.0F, -16.0F, 70.0F, 30.0F);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Desktop\XSJ Client v2.3 New Year's Special Edition.jar!\net\ccbluex\liquidbounc\\ui\client\hud\element\elements\Username.class
