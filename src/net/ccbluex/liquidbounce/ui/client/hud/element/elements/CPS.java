...
/*     */   
/*  25 */   public CPS() { super(0.0D, 0.0D, 0.0F, null, 15, null);
/*     */ 
/*     */ 
/*     */     
...
/* 149 */             ScaleUtils.drawGidentOutlinedRoundedRect3(-1.0D, 0.0D, 72.0D, 16.0D, 6.4D, ((Number)CustomColor.line.get()).floatValue());  }  break;case 110119: if (str.equals("old")) { if (MinecraftInstance.mc.getThePlayer() == null)
...
/*     */       case 66125871:
/*     */         if (str.equals("outline1")) { RoundedUtil.drawRound(-1.0F, 0.0F, 72.0F, 16.0F, 6.4F, new Color(0, 0, 0, ((Number)this.bgValue.get()).intValue())); if (((Boolean)this.Outline.get()).booleanValue())
/*     */             ScaleUtils.drawOutline(5.0F, 0.0F, 66.0F, 4.0F, 6.4F, ((Number)CustomColor.line.get()).floatValue(), 3.0F);  }
/*     */          break;
/* 172 */     }  Intrinsics.checkExpressionValueIsNotNull(Color.white, "Color.white"); CFontLoad.CP24.drawString("A", 4.0F, 5.0F, Color.white.getRGB());
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 178 */     Intrinsics.checkExpressionValueIsNotNull(Color.white, "Color.white"); CFontLoad.for18.drawString(String.valueOf(CPSCounter.getCPS(CPSCounter.MouseButton.LEFT)) + " | " + String.valueOf(CPSCounter.getCPS(CPSCounter.MouseButton.RIGHT)) + " CPS", 21.0F, (float)7, Color.white.getRGB());
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\XSJ Client v2.3 New Year's Special Edition.jar!\net\ccbluex\liquidbounc\\ui\client\hud\element\elements\CPS.class
