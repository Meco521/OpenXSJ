...
/*      */ 
/*      */     
/*      */     Scaffold2$staticYawOffsetValue$1() {
/*      */       super(0);
/*      */     } }
/*      */ 
/*      */ 
...
/*      */   
/*      */   @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 3, d1 = {"\000\b\n\000\n\002\020\013\n\000\020\000\032\0020\001H\n¢\006\002\b\002"}, d2 = {"<anonymous>", "", "invoke"})
/*      */   static final class Scaffold2$zitterModeValue$1
/*      */     extends Lambda
/*      */     implements Function0<Boolean>
/*      */   {
/*      */     public final boolean invoke() {
/*  148 */       return ((Boolean)Scaffold2.this.zitterValue.get()).booleanValue();
/*  149 */     } Scaffold2$zitterModeValue$1() { super(0); } } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 3, d1 = {"\000\b\n\000\n\002\020\013\n\000\020\000\032\0020\001H\n¢\006\002\b\002"}, d2 = {"<anonymous>", "", "invoke"}) static final class Scaffold2$zitterSpeed$1 extends Lambda implements Function0<Boolean> { public final boolean invoke() { return ((Boolean)Scaffold2.this.zitterValue.get()).booleanValue(); } Scaffold2$zitterSpeed$1() { super(0); } }
/*  150 */   @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 3, d1 = {"\000\b\n\000\n\002\020\013\n\000\020\000\032\0020\001H\n¢\006\002\b\002"}, d2 = {"<anonymous>", "", "invoke"}) static final class Scaffold2$zitterStrength$1 extends Lambda implements Function0<Boolean> { public final boolean invoke() { return ((Boolean)Scaffold2.this.zitterValue.get()).booleanValue(); }
/*      */     
/*      */     Scaffold2$zitterStrength$1() {
/*      */       super(0);
/*      */     } }
/*      */   @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 3, d1 = {"\000\b\n\000\n\002\020\013\n\000\020\000\032\0020\001H\n¢\006\002\b\002"}, d2 = {"<anonymous>", "", "invoke"})
/*      */   static final class Scaffold2$slowSpeed$1 extends Lambda implements Function0<Boolean> { Scaffold2$slowSpeed$1() {
/*      */       super(0);
/*      */     }
/*      */     
/*  160 */     public final boolean invoke() { return ((Boolean)Scaffold2.this.slowValue.get()).booleanValue(); } } @NotNull private final ListValue modeValue = new ListValue("Mode", new String[] { "Normal", "Rewinside", "Expand" }, "Normal"); @NotNull public final ListValue getModeValue() { return this.modeValue; } private final BoolValue noBlockDisablerValue = new BoolValue("NoBlockDisabler", false); private final BoolValue placeableDelay = new BoolValue("PlaceableDelay", false); private final IntegerValue maxDelayValue; private final IntegerValue minDelayValue; private final ListValue autoBlockValue; @NotNull private final BoolValue sprintValue; private final BoolValue swingValue; private final BoolValue searchValue; private final BoolValue downValue; private final ListValue placeModeValue; private final ListValue eagleValue; private final Value<Integer> blocksToEagleValue; private final Value<Float> edgeDistanceValue; private final Value<Integer> expandLengthValue; private final BoolValue rotationStrafeValue; private final ListValue rotationModeValue; private final BoolValue silentRotation; private final BoolValue keepRotationValue; private final Value<Integer> keepLengthValue; private final Value<Float> staticPitchValue; private final Value<Float> staticYawOffsetValue; private final FloatValue xzRangeValue; private final FloatValue yRangeValue; private final IntegerValue searchAccuracyValue; private final FloatValue maxTurnSpeedValue; private final FloatValue minTurnSpeedValue; private final BoolValue zitterValue; public Scaffold2() { if ((new Scaffold2$maxDelayValue$1("MaxDelay", 0, 0, 1000)).displayable(new Scaffold2$maxDelayValue$2()) == null) throw new TypeCastException("null cannot be cast to non-null type net.ccbluex.liquidbounce.value.IntegerValue");  this.maxDelayValue = (IntegerValue)(new Scaffold2$maxDelayValue$1("MaxDelay", 0, 0, 1000)).displayable(new Scaffold2$maxDelayValue$2()); if ((new Scaffold2$minDelayValue$1("MinDelay", 0, 0, 1000)).displayable(new Scaffold2$minDelayValue$2()) == null) throw new TypeCastException("null cannot be cast to non-null type net.ccbluex.liquidbounce.value.IntegerValue");  this.minDelayValue = (IntegerValue)(new Scaffold2$minDelayValue$1("MinDelay", 0, 0, 1000)).displayable(new Scaffold2$minDelayValue$2()); this.autoBlockValue = new ListValue("AutoBlock", new String[] { "Off", "Spoof", "Pick", "Switch" }, "Spoof"); this.sprintValue = new BoolValue("Sprint", true); this.swingValue = new BoolValue("Swing", true); this.searchValue = new BoolValue("Search", true); this.downValue = new BoolValue("Down", true); this.placeModeValue = new ListValue("PlaceTiming", new String[] { "Pre", "Post" }, "Post"); this.eagleValue = new ListValue("Eagle", new String[] { "Normal", "EdgeDistance", "Silent", "Off" }, "Off"); this.blocksToEagleValue = (new IntegerValue("BlocksToEagle", 0, 0, 10)).displayable(new Scaffold2$blocksToEagleValue$1()); this.edgeDistanceValue = (new FloatValue("EagleEdgeDistance", 0.2F, 0.0F, 0.5F)).displayable(new Scaffold2$edgeDistanceValue$1()); this.expandLengthValue = (new IntegerValue("ExpandLength", 5, 1, 6)).displayable(new Scaffold2$expandLengthValue$1()); this.rotationStrafeValue = new BoolValue("RotationStrafe", false); this.rotationModeValue = new ListValue("RotationMode", new String[] { "Normal", "Static", "StaticPitch", "StaticYaw", "Off" }, "Normal"); this.silentRotation = new BoolValue("SilentRotation", true); this.keepRotationValue = new BoolValue("KeepRotation", false); this.keepLengthValue = (new IntegerValue("KeepRotationLength", 0, 0, 20)).displayable(new Scaffold2$keepLengthValue$1()); this.staticPitchValue = (new FloatValue("StaticPitchOffset", 86.0F, 70.0F, 90.0F)).displayable(new Scaffold2$staticPitchValue$1()); this.staticYawOffsetValue = (new FloatValue("StaticYawOffset", 0.0F, 0.0F, 90.0F)).displayable(new Scaffold2$staticYawOffsetValue$1()); this.xzRangeValue = new FloatValue("xzRange", 0.8F, 0.1F, 1.0F); this.yRangeValue = new FloatValue("yRange", 0.8F, 0.1F, 1.0F); this.searchAccuracyValue = new Scaffold2$searchAccuracyValue$1("SearchAccuracy", 8, 1, 24); this.maxTurnSpeedValue = new Scaffold2$maxTurnSpeedValue$1("MaxTurnSpeed", 180.0F, 1.0F, 180.0F); this.minTurnSpeedValue = new Scaffold2$minTurnSpeedValue$1("MinTurnSpeed", 180.0F, 1.0F, 180.0F); this.zitterValue = new BoolValue("Zitter", false); this.zitterModeValue = (new ListValue("ZitterMode", new String[] { "Teleport", "Smooth" }, "Teleport")).displayable(new Scaffold2$zitterModeValue$1()); this.zitterSpeed = (new FloatValue("ZitterSpeed", 0.13F, 0.1F, 0.3F)).displayable(new Scaffold2$zitterSpeed$1()); this.zitterStrength = (new FloatValue("ZitterStrength", 0.072F, 0.05F, 0.2F)).displayable(new Scaffold2$zitterStrength$1()); this.timerValue = new FloatValue("Timer", 1.0F, 0.1F, 10.0F); this.speedModifierValue = new FloatValue("SpeedModifier", 1.0F, 0.0F, 2.0F); this.slowValue = new Scaffold2$slowValue$1("Slow", false); this.slowSpeed = (new FloatValue("SlowSpeed", 0.6F, 0.2F, 0.8F)).displayable(new Scaffold2$slowSpeed$1());
/*      */     
...
/*      */   private float progress; private final BoolValue sameYValue; private final BoolValue smartSpeedValue; private final BoolValue autoJumpValue; private final BoolValue safeWalkValue; private final BoolValue airSafeValue; private final BoolValue counterDisplayValue; private final BoolValue markValue; private final BoolValue autoTimer; private PlaceInfo targetPlace; private int launchY; private Rotation lockRotation; private Rotation limitedRotation; private boolean facesBlock; private int slot; private boolean zitterDirection; private final MSTimer delayTimer; private final MSTimer zitterTimer; private long delay; private int placedBlocksWithoutEagle; private boolean eagleSneaking; private boolean shouldGoDown; @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\b\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$maxDelayValue$1", "Lnet/ccbluex/liquidbounce/value/IntegerValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$maxDelayValue$1 extends IntegerValue {
/*      */     Scaffold2$maxDelayValue$1(String $super_call_param$1, int $super_call_param$2, int $super_call_param$3, int $super_call_param$4) { super($super_call_param$1, $super_call_param$2, $super_call_param$3, $super_call_param$4); } protected void onChanged(int oldValue, int newValue) { int i = ((Number)Scaffold2.this.minDelayValue.get()).intValue(); if (i > newValue) set(Integer.valueOf(i));  } } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\b\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$minDelayValue$1", "Lnet/ccbluex/liquidbounce/value/IntegerValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$minDelayValue$1 extends IntegerValue {
/*      */     Scaffold2$minDelayValue$1(String $super_call_param$1, int $super_call_param$2, int $super_call_param$3, int $super_call_param$4) { super($super_call_param$1, $super_call_param$2, $super_call_param$3, $super_call_param$4); } protected void onChanged(int oldValue, int newValue) { int i = ((Number)Scaffold2.this.maxDelayValue.get()).intValue(); if (i < newValue) set(Integer.valueOf(i));  } } @NotNull public final BoolValue getSprintValue() { return this.sprintValue; } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\b\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$searchAccuracyValue$1", "Lnet/ccbluex/liquidbounce/value/IntegerValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$searchAccuracyValue$1 extends IntegerValue {
/*      */     Scaffold2$searchAccuracyValue$1(String $super_call_param$0, int $super_call_param$1, int $super_call_param$2, int $super_call_param$3) { super($super_call_param$0, $super_call_param$1, $super_call_param$2, $super_call_param$3); } protected void onChanged(int oldValue, int newValue) { if (getMaximum() < newValue) { set(Integer.valueOf(getMaximum())); } else if (getMinimum() > newValue) { set(Integer.valueOf(getMinimum())); }  } } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\007\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$maxTurnSpeedValue$1", "Lnet/ccbluex/liquidbounce/value/FloatValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$maxTurnSpeedValue$1 extends FloatValue {
/*      */     Scaffold2$maxTurnSpeedValue$1(String $super_call_param$1, float $super_call_param$2, float $super_call_param$3, float $super_call_param$4) { super($super_call_param$1, $super_call_param$2, $super_call_param$3, $super_call_param$4); } protected void onChanged(float oldValue, float newValue) { float v = ((Number)Scaffold2.this.minTurnSpeedValue.get()).floatValue(); if (v > newValue) set(Float.valueOf(v));  if (getMaximum() < newValue) { set(Float.valueOf(getMaximum())); } else if (getMinimum() > newValue) { set(Float.valueOf(getMinimum())); }  } } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\007\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$minTurnSpeedValue$1", "Lnet/ccbluex/liquidbounce/value/FloatValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$minTurnSpeedValue$1 extends FloatValue {
/*      */     Scaffold2$minTurnSpeedValue$1(String $super_call_param$1, float $super_call_param$2, float $super_call_param$3, float $super_call_param$4) { super($super_call_param$1, $super_call_param$2, $super_call_param$3, $super_call_param$4); } protected void onChanged(float oldValue, float newValue) { float v = ((Number)Scaffold2.this.maxTurnSpeedValue.get()).floatValue(); if (v < newValue) set(Float.valueOf(v));  if (getMaximum() < newValue) { set(Float.valueOf(getMaximum())); } else if (getMinimum() > newValue) { set(Float.valueOf(getMinimum())); }  } } @Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"\000\031\n\000\n\002\030\002\n\000\n\002\020\002\n\000\n\002\020\013\n\002\b\002*\001\000\b\n\030\0002\0020\001J\030\020\002\032\0020\0032\006\020\004\032\0020\0052\006\020\006\032\0020\005H\024¨\006\007"}, d2 = {"net/ccbluex/liquidbounce/features/module/modules/world/Scaffold2$slowValue$1", "Lnet/ccbluex/liquidbounce/value/BoolValue;", "onChanged", "", "oldValue", "", "newValue", "XSJClient"}) public static final class Scaffold2$slowValue$1 extends BoolValue {
/*  209 */     Scaffold2$slowValue$1(String $super_call_param$1, boolean $super_call_param$2) { super($super_call_param$1, $super_call_param$2); } protected void onChanged(boolean oldValue, boolean newValue) { if (newValue) Scaffold2.this.getSprintValue().set(Boolean.valueOf(false));  } } public void onEnable() { if (MinecraftInstance.mc.getThePlayer() == null)
...
/*  289 */           { Scaffold2 scaffold21; WBlockPos blockPos; boolean bool1; PlaceInfo placeInfo; boolean bool2; int $i$f$isReplaceable; Scaffold2 $this$run; int $i$a$-run-Scaffold2$onUpdate$1; int $i$a$-run-Scaffold2$onUpdate$5; int $i$a$-run-Scaffold2$onUpdate$8; switch (b1)
/*      */             { case 0:
/*  291 */                 scaffold21 = this; bool1 = false; bool2 = false; $this$run = scaffold21; $i$a$-run-Scaffold2$onUpdate$1 = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */               
/*      */               case 1:
/*  354 */                 scaffold21 = this; bool1 = false; bool2 = false; $this$run = scaffold21; $i$a$-run-Scaffold2$onUpdate$5 = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */               
/*      */               case 2:
/*  402 */                 scaffold21 = this; bool1 = false; bool2 = false; $this$run = scaffold21; $i$a$-run-Scaffold2$onUpdate$8 = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     //   0	146	0	this	Lnet/ccbluex/liquidbounce/features/module/modules/world/Scaffold2;
/*      */   }
/*      */   
...
/*      */     //   0	874	0	this	Lnet/ccbluex/liquidbounce/features/module/modules/world/Scaffold2;
/*      */     //   0	874	1	expand	Z
/*      */   }
/*      */   
...
/*      */     //   0	819	0	this	Lnet/ccbluex/liquidbounce/features/module/modules/world/Scaffold2;
/*      */   }
/*      */   
...
/*      */     //   0	2288	0	this	Lnet/ccbluex/liquidbounce/features/module/modules/world/Scaffold2;
...
/* Location:              C:\Users\Administrator\Desktop\XSJ Client v2.3 New Year's Special Edition.jar!\net\ccbluex\liquidbounce\features\module\modules\world\Scaffold2.class
