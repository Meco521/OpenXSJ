...
/*  16 */   public static final float PI = MathUtils.roundToFloat(Math.PI);
/*  17 */   public static final float PI2 = MathUtils.roundToFloat(6.283185307179586D);
/*  18 */   public static final float PId2 = MathUtils.roundToFloat(1.5707963267948966D);
/*  19 */   private static final float radToIndex = MathUtils.roundToFloat(651.8986469044033D);
/*  20 */   public static final float deg2Rad = MathUtils.roundToFloat(0.017453292519943295D);
/*  21 */   private static final float[] SIN_TABLE_FAST = new float[4096];
/*     */ 
/*     */   
/*     */   public static boolean fastMath = false;
/*     */ 
/*     */   
/*  27 */   private static final float[] SIN_TABLE = new float[65536];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */     return (slide < 0.0D) ? lowerBnd : ((slide > 1.0D) ? upperBnd : (lowerBnd + (upperBnd - lowerBnd) * slide));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 403 */     return getCoordinateRandom(pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 565 */     for (int j = 0; j < SIN_TABLE_FAST.length; j++)
/*     */     {
/* 567 */       SIN_TABLE_FAST[j] = MathUtils.roundToFloat(Math.sin(j * Math.PI * 2.0D / 4096.0D)); } 
/*     */   }
/*     */   
/* 570 */   private static final int[] multiplyDeBruijnBitPosition = new int[] { 0, 1, 28, 2, 29, 14, 24, 3, 30, 22, 20, 15, 25, 17, 4, 8, 31, 27, 13, 23, 21, 19, 16, 7, 26, 12, 18, 6, 11, 5, 10, 9 };
/* 571 */   private static final double field_181163_d = Double.longBitsToDouble(4805340802404319232L);
/* 572 */   private static final double[] field_181164_e = new double[257];
/* 573 */   private static final double[] field_181165_f = new double[257];
/*     */   static {
/* 575 */     for (int k = 0; k < 257; k++) {
/*     */       
/* 577 */       double d0 = k / 256.0D;
/* 578 */       double d1 = Math.asin(d0);
/* 579 */       field_181165_f[k] = Math.cos(d1);
/* 580 */       field_181164_e[k] = d1;
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Desktop\XSJ Client v2.3 New Year's Special Edition.jar!\tomk\MathHelper.class
