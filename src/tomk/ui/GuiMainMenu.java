...
/* 186 */       Fonts.font35.drawCenteredString(
/* 187 */           "@6034", this.$sr.func_78326_a() / 2.0F - 5, this.$sr.func_78328_b() - 5.0F - Fonts.font35.getFontHeight(), (
/* 188 */           new Color(200, 200, 200)).getRGB(), true);
/* 189 */       Fonts.tenacitybold50.drawCenteredString("v2.3 New Year's Special Edition", 70.0F, 27.0F, (
/* 190 */           new Color(235, 235, 235)).getRGB(), false);
/*     */       
/* 192 */       GlStateManager.func_179098_w();
/* 193 */       GlStateManager.func_179084_k();
